...
<p class="TopLine">The Premier Engineering College of Jharkhand.</p>
<!-- <h1 class="Heading" >The primary aim of the Institute is to cater to the requirements of the country for Technological Manpower for development and research programs comparable to the best of the world.</h1> -->
...
<p class="Subtitle">The college has top-notch amenities, and a campus-wide network ,a good hostels and food services.</p>
<div class="BtnWrap">
<button type="button" name="button" class="NavBtnLink" onclick="change()">Get Started</button>
</div>
</div>
...
<div class="FooterWrap">
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      <a href="#" class="SocialLogo">SECOND TO NONE</a>
      <p class="WebsiteRights">BIT SINDRI © 2023</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/bitsaa.co.in/" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <!-- <a href="https://twitter.com/VIT_univ?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a> -->
         <a href="https://twitter.com/BITSindriDhn" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
       
         <!-- <a href="https://www.instagram.com/vellore_vit/?hl=en" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a> -->
         <a href="https://www.instagram.com/bit_sindri_2021/?hl=en" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>

       
         <a href="https://www.youtube.com/watch?v=BS6mAxCwP0E" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
