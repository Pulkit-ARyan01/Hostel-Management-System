      ...
      <form action="registration.php"   method="post">
        <div class="user-details">
          <div class="input-box">
            ...
            <input name="name" type="text" placeholder="Enter your name" value="<?php echo "$name"; ?>"  pattern="[a-z A-Z]*">
          </div>
          <div class="input-box">
            <span class="details">Reg No</span>
            <input type="text" placeholder="Enter your regno" name="regno" value="<?php echo "$regno"; ?>" pattern="[0-9]{2}[A-Z]{3}[0-9]{4}" >
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your number" name="phoneno" value="<?php echo "$phoneno"; ?>" pattern="[0-9]{10}" >
          </div>
          <div class="input-box">
